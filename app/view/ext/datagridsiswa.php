...
<body>
    <table id="tt" class="easyui-datagrid" style="width:98%;"
            ...
            title="Data siswa Yayasan Darul Ilmi" iconCls="icon-search" toolbar="#tb"
            rownumbers="true" pagination="true">
        <thead frozen="true">
            <tr>
                <th field="nm_lengkap" width="280">Nama</th>
            </tr>
        </thead>
        <thead>
            <tr>
                <th field="nm_panggilan" width="100" align="center"> Panggilan</th>
                <th field="tgl_lahir" width="80" align="center" > Tgl Lahir </th>
                <th field="t4_lahir" width="75" align="center" > T4 Lahir </th>
                <th field="anak_ke" width="75" align="center" >anak Ke </th>
                <th field="kelas" width="35" align="center" sortable="true">Kelas</th>
                <th field="is_male" width="35" align="center" sortable="true">Gender</th>
                <th field="alamat" width="80" align="center"> Alamat</th>
                <th field="NISN" width="80" align="center"> NIS Nasional</th>
                <th field="NISL" width="80" align="center"> NIS Lokal</th>
                <th field="TK_asal" width="80" align="center"> TK Asal</th>
                <th field="finance" width="75" align="center"> Finansial</th>
                <th field="kewalian" width="105" align="center">Kewalian</th>
                <th field="AA" width="80" >blm_define AA</th>
                <th field="BB" width="80" > blm_define BB</th>
                <th field="CC" width="80" > blm</th>
                <th field="DD" width="80" > blm</th>
                <th field="EE" width="75" > blm_define</th>
                <th field="FF" width="75" >  blm_define</th>
                <th field="GG" width="75" >  blm_define</th>
                <th field="HH" width="80" >  blm_define</th>
                <th field="II" width="80" >  blm_define</th>
                <th field="JJ" width="80" >  blm_define</th>
                <th field="KK" width="80" >  blm_define</th>
                <th field="LL" width="80" >  blm_define</th>
                <th field="MM" width="75" align="center">  blm_define</th>
                <th field="Remark" width="105"> Remark</th>
    ...
    <div id="tb" style="padding:3px">
        ...
        <div id="mm10" style="width:200px;">
            ...
            <div><a href="http://support.nec.co.id/pi/jeasy/jaguarpivot.php">Summary Progress Table</a></div>
            <div  onclick="open_map()">Jaguar Map</div>
            ...
            <div onclick="graph_daily">Graph Trend of Daily Progress</div>
            <div class="menu-sep"></div>
            <div onclick="open_upd_reqst()">Queue Update Request</div>
            <div><a href="csv_export">CSV file exporter</a></div>
            <div class="menu-sep"></div>
            <div>
                <span>Material</span>
                <div style="width:150px;">
                    <div onclick="open_mat_tabulasi()">Tabulasi Material</div>
                    <div onclick="open_mat_trans_list()">Transaction List</div>
                </div>
            </div>
	    ...
	    <!-- div><a href="gantt">GANTT Chart</a></div -->
            ...
            <div>
                ...
                <div style="width:150px;">
                    ...
                    <div onclick="changecolumnNMS()">NMS view</div>
                    <div onclick="changecolumnDismtl()">Dismantle view</div>
                    <div onclick="changecolumnTraffMigr()">Traff Migration view</div>
                </div>
            </div>
        </div>
        ...
        <div id="mm2" style="width:180px;">
            <div>Help</div>
            <div><a href="http://support.nec.co.id/pi/video/PM Tools.ppt">PPT User Manual</a></div>
            <div><a href="http://support.nec.co.id/pi/video/">Video for User Manual</a></div>
            <div>About</div>
        </div>
	...
	<div class="menu-sep"></div>
        ...
        id="filterstatus"
        data-options="
                url:'ISATMBSKAL_combo_status.php',
                method:'get',
                valueField:'text',
                textField:'text',
                multiple:true,
        ...
        SEQ:<!--span>Nama Barang:</span-->
        <input class="easyui-combobox"  style="width:50px"
        id="filterseq"
        data-options="
                url:'dg_siswa/combo_seq',
                method:'get',
                valueField:'text',
                textField:'text',
                multiple:true,
...
function doSearch(value){
    var opts = $('#filterstatus').combobox('options');
    var opts_seq = $('#filterseq').combobox('options');
    ...
    if (opts_seq.multiple){pilihan1 = $('#filterseq').combobox('getValues').join(opts.separator);    }
    if (opts_grp.multiple){ pilihan2 = $('#filtergrp').combobox('getValues').join(opts.separator);    }
    if (opts.multiple){ pilihan = $('#filterstatus').combobox('getValues').join("','");    }
    ...
    $('#tt').datagrid('load',{nama: value, posow: pilihan, seq: pilihan1, grp: pilihan2, spteam: pilihan3, lstatus: pilihan4, progap: pilihan5});
}
