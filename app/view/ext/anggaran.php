...
<body>
    <table id="tt" class="easyui-datagrid" style="width:98%;"
            ...
            title="Rencana Cash Flow Operasional Sekolah Daarul Ilmi Depok" iconCls="icon-search" toolbar="#tb"
            rownumbers="true" pagination="true">
        <thead frozen="true">
            <tr>
                <th field="id_cost" width="80">ID_COST</th>
		<th field="id_cost_ctgr" width="80">category</th>
                <th field="nm_biaya" width="280">Nama Pembiayaan</th>
            </tr>
        </thead>
        <thead>
            <tr>
                ...
                <th field="in_out" width="100" align="center"> Cash Flow</th>
                ...
                <th field="val_commit" width="75" align="center" >Rp tlh commit</th>
                <th field="val_plan" width="80" > Rp rencana</th>
                <th field="val_executed" width="80" > Rp Realisasi</th>
                <th field="creator" width="135" align="center" sortable="true">pembuat</th>
                <th field="respsbl" width="135" align="center" sortable="true">penanggung jawab</th>
                <th field="approved" width="80" align="center"> Disetujui</th>
                <th field="is_commit" width="80" align="center"> sdh kommit</th>
                <th field="is_exec" width="75" align="center"> eksekusi</th>
                <th field="persen_serapan" width="75" align="center"> Persen serapan</th>
