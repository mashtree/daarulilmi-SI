...
<body>
    <table id="tt" class="easyui-datagrid" style="width:98%;"
            ...
            title="Sistem Inventaris Sekolah Daarul Ilmi Depok" iconCls="icon-search" toolbar="#tb"
            rownumbers="true" pagination="true">
        <thead frozen="true">
            <tr>
                <th field="id_inventory" width="80">ID Inventaris</th>
		<th field="id_ctgr" width="80">category</th>
                <th field="nm_lengkap" width="280">Nama Barang</th>
            </tr>
        </thead>
        <thead>
            <tr>
                <th field="Lokasi" width="80" align="center"> Lokasi</th>
                <th field="supplier" width="100" align="center"> Supplier</th>
                <th field="tgl_beli" width="75" align="center" > Tanggal Beli </th>
                <th field="thn_buat" width="75" align="center" >Thn Pembuatan</th>
                <th field="expired_date" width="80" > Tgl Expired</th>
                <th field="spesifikasi" width="135" align="center" sortable="true">spesifikasi</th>
                <th field="Kondisi" width="80" align="center"> Kondisi</th>
                <th field="NISL" width="80" align="center"> NIS Lokal</th>
                <th field="harga_beli" width="75" align="center"> harga beli</th>
                <th field="persen_nilai" width="75" align="center"> Persen nilai akhir</th>
                <th field="start_pakai" width="80" >Tgl Mulai Pakai</th>
                <th field="end_pakai" width="80" > Tgl Akhir Pakai</th>
                <th field="lvl_rusak" width="80" >Level Kerusakan</th>
                <th field="lvl_layak" width="80" >Level Layak</th>
                <th field="asal" width="75" > Asal Barang</th>
